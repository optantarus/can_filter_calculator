...
class can_filter_calc_test(unittest.TestCase):
    ...
    def test_calc_11bit_ids(self):
        ...
        canCalc = can_filter_calc.CanFilterCalc(['', '-f=test_can_ids_11bit.txt', '-s=11', '-n=2'])
    ...
    def test_calc_29bit_ids(self):
        ...
        canCalc = can_filter_calc.CanFilterCalc(['', '-f=test_can_ids_29bit.txt', '-s=29', '-n=2'])
        test_lists, test_filters, test_num = canCalc.calc()
    ...
    def test_calc_3_filters(self):
        ...
        canCalc = can_filter_calc.CanFilterCalc(['', '-f=test_can_ids_11bit.txt', '-s=11', '-n=3'])
        test_lists, test_filters, test_num = canCalc.calc()
